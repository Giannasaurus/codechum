...
/** passed test cases
  ...
  * test case 3:
    > Enter kilometers per hour: 37.77
      ...
      Distance in miles: 117.346
  * test case 4:
    > Enter kilometers per hour: 320
      Enter number of hours traveled: 5
      Distance in miles: 994.194
  * test case 5:
    > Enter kilometers per hour: 947
      Enter number of hours traveled: 7
      Distance in miles: 4119.068
  * test case 6:
    > Enter kilometers per hour: 1
      Enter number of hours traveled: 10
      Distance in miles: 6.214 */
